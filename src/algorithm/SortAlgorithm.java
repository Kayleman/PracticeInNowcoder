...
public class SortAlgorithm {
    ...
    private static void maxHeapify(int[] array, int limit){
        if(array.length <= 0 || array.length < limit) return;
        //因为前面传入参数是从array.length开始计算的，所以相当于根节点坐标从1开始
        //所以父节点是i/2，左孩子 2 * i,右孩子 2 * i + 1
        ...
        System.out.println("Max_Heapify: " + Arrays.toString(array));
    }
